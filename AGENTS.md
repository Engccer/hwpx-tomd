...
## 현재 상태: 코어 구현·검증 완료 (마이그레이션 대기)

패키지 코어가 구현·검증되었다(2026-06-05). 배경·설계·로드맵 상세는 [`PLAN.md`](PLAN.md) 참조.
...
- **대기**: hwpx-automation 마이그레이션(로드맵 7), docparse 마이그레이션(8), 공개(9, TestPyPI/PyPI), 멀티 디바이스 배포(10).
